...
<div class="col-md-5 mt-5">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-info">
            <h3 class="text-center">@guest Admin Login @else Welcome back {{ Auth::user()->name }}  @endguest</h3>
        </div>
        <div class="card-body py-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-center mb-4"> You're Logged in</h3>
                </div>
                <div class="col-md-6">
                    <a href="{{ route('admin-home') }}" class="btn btn-info btn-block btn-lg"> Dashboard </a>
                </div>
                <div class="col-md-6">
